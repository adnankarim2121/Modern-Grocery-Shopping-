...
namespace LinkShortener.Models.Database
{
    ...
    public abstract partial class AbstractDatabase
    {
        ...
        protected AbstractDatabase()
        {
            ...
            connection = new MySqlConnection("SERVER=35.192.140.37;DATABASE=mysql;UID=" + UID + ";AUTO ENLIST=false;PASSWORD=" + Password);
            createDB();
        }
    ...
    public abstract partial class AbstractDatabase
    {
        ...
        /// </summary>
        private const string Password = "plusplusguys";

	...
	<div class="gtco-section border-bottom" style="background-image: url(images/produce4.jpeg)">
		<div class="gtco-container">
			...
			<div class="row">
					...
					$result = mysqli_query($con, "SELECT supplier_name, supplier_phone_number, supplier_location FROM supplier WHERE supplier_name='".$supplier_name."'");
					 if (mysqli_num_rows($result) == 0 ) #email/password combo doesnt exist, so tell user to try again
							 {
							 	echo "<h1 style='color:#FFFFFF'>Supplier Does Not Exist. Please Try Again.</h1>";
					...
					while($row = mysqli_fetch_array($result))
					 ...
					 echo "<td>" . $row['supplier_phone_number'] . "</td>";
